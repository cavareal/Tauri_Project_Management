...
const DIALOG_TITLE = "Exporter le barème"
const DIALOG_DESCRIPTION = "Vous pouvez exporter le fichier contenant le barème associé à la note au format PDF."

const { isPending, error, mutate: download } = useMutation({ mutationKey: ["export-grade-scale"], mutationFn: async() => {
