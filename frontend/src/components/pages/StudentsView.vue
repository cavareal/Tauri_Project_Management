	...
	<PageTemplate >
		<div class="flex flex-col items-center px-20 py-16 max-md:px-5">
			<div v-if="!studentsImported">
				...
				<div class="flex flex-col p-6 mt-5 w-full text-sm bg-white rounded-md border border-solid border-slate-300 max-w-[1140px] max-md:px-5 max-md:max-w-full">
			...
			<div v-if="popupVisible" class="z-1 flex flex-col self-center p-6 mt-5 max-w-full bg-white rounded-lg border border-solid border-slate-300 w-[487px] max-md:px-5">
				<div>
					<form @submit="formSubmit" action="./students">
						...
						<div class="flex flex-col justify-center p-4 mt-8 leading-5 text-center bg-white rounded-md border border-dashed text-slate-500 max-md:max-w-full">
						...
						<div class="flex gap-5 pl-20 mt-8 font-medium leading-6 whitespace-nowrap max-md:flex-wrap max-md:pl-5">
							<Button class="justify-center px-4 py-2 bg-white rounded-md border border-solid border-slate-200 text-slate-900" action="./students">Annuler</Button>
			...
			<StudentsTable v-if="studentsImported"/>
		</div>
	</PageTemplate>
