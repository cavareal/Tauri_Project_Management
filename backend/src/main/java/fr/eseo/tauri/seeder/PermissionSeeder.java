...
public class PermissionSeeder {
	...
	private static final Map<RoleType, List<PermissionType>> PERMISSIONS = Map.of(
			...
			RoleType.OPTION_LEADER, List.of(GET_ACTUAL_PROJECT, IMPORT, MODIFICATION_STUDENT_LIST, MANAGE_SPRINT, VIEW_ALL_WRITING_GRADES, EXPORT_INDIVIDUAL_GRADES, STUDENTS_PAGE, TEAMS_PAGE, SPRINTS_PAGE, GRADES_PAGE),

			RoleType.PROJECT_LEADER, List.of(IMPORT, MODIFICATION_STUDENT_LIST, EDIT_IMPORTED_GRADE_TYPES, EXPORT_STUDENT_LIST, TEAM_CREATION, TEAM_MANAGEMENT, PUBLISH_TEAMS, MANAGE_SPRINT, MANAGE_GRADE_SCALE, VIEW_ALL_WRITING_GRADES, VERIFY_ALL_KEYS_USED, EXPORT_INDIVIDUAL_GRADES, STUDENTS_PAGE, TEAMS_PAGE, SPRINTS_PAGE, GRADES_PAGE, GRADE_SCALES_PAGE, MANAGE_PROJECT, ADD_USER, DELETE_USER, GET_ALL_USERS, ADD_PROJECT, DELETE_PROJECT, SET_ACTUAL_PROJECT, GET_ACTUAL_PROJECT),

			RoleType.OPTION_STUDENT, List.of(GET_ACTUAL_PROJECT, FLAG_TEAM_WITH_STUDENTS, VIEW_TEAM_CHANGES, VALIDATION_OWN_TEAM, VIEW_TEAMS, VIEW_OWN_TEAM, VIEW_SPRINT_PROTOCOL, VIEW_OWN_SPRINT_GRADE, TEAMS_PAGE, MY_TEAM_PAGE, SPRINTS_PAGE, GRADES_PAGE, RATING_PAGE),
