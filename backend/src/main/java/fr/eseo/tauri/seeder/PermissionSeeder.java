...
public class PermissionSeeder {
	...
	private static final Map<RoleType, List<PermissionType>> PERMISSIONS = Map.of(
			...
			RoleType.TECHNICAL_COACH, List.of(GRADE_SUPPORT_MATERIAL, GRADE_PRESENTATION_CONTENT, ADD_COMMENT_WG, ADD_ALL_TEAMS_COMMENT, ADD_ALL_TEAMS_FEEDBACK, VIEW_FEEDBACK, SPRINTS_PAGE, GRADES_PAGE, RATING_PAGE, ADD_ALL_TEAMS_COMMENT, VIEW_COMMENT),
